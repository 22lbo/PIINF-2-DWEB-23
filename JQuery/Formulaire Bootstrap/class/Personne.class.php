...
Class Personne {
    ...
    public function set_id($id) { //@param string $id
        $this->id = $id;
    }
    public function get_id() { //@return string $id
        return $this->id;
    }

    public function set_nom($nom) { //@param string $nom
        $this->nom = $nom;
    }
    public function get_nom() { //@return string $nom
        return $this->nom;
    }

    public function set_prenom($prenom) { //@param string $prenom
        $this->prenom = $prenom;
    }
    public function get_prenom() { //@return string $prenom
        return $this->prenom;
    }

    public function set_email($email) { //@param string $email
        $this->email = $email;
    }
    public function get_email() { //@return string $email
        return $this->email;
    }

    public function set_password($password) { //@param string $password
        $this->password = $password;
    }
    public function get_password() { //@return string $password
        return $this->password;
    }

    public function set_news_letter($news_letter) { // @param string $news_letter
        $this->news_letter = $news_letter;
    }
    public function get_news_letter() { //@return string $news_letter
